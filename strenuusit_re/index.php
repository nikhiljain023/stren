...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  if(isset($data -> operation)){
  	...
  	if(!empty($operation)){
       ...
       if ($operation == 'dayreport') {

        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> old_password) 
          ){
          ...
          echo $fun -> dayReport($old_password);
       ...
       if ($operation == 'shiftreport') {
        ...
        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> old_password) 
          ...
          echo $fun -> shiftReport($old_password, $new_password);
      ...
      if ($operation == 'boothreport') {
        ...
        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> name) 
          ...
          echo $fun -> boothReport($name, $email,$password);
